...
const getWeekNumber = (date) => {
  ...
  // Define para a quinta-feira da semana para garantir a consistência da semana ISO 8601
...
// --- DADOS HISTÓRICOS DE METEOROLOGIA POR SEMANA (1-52) ---
const weeklyHistoricalWeather = {
  // Janeiro
  ...
  2: { min: "19°C", max: "28°C", horarios: [{hora:"07h", temp:"20°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "75%", periodoChuva: "Pancadas de chuva frequentes à tarde.", umidade: "70% - 95%" },
  3: { min: "19°C", max: "28°C", horarios: [{hora:"07h", temp:"20°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "75%", periodoChuva: "Pancadas de chuva frequentes à tarde.", umidade: "70% - 95%" },
  4: { min: "19°C", max: "28°C", horarios: [{hora:"07h", temp:"20°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "75%", periodoChuva: "Pancadas de chuva frequentes à tarde.", umidade: "70% - 95%" },
  // Fevereiro
  5: { min: "19°C", max: "28°C", horarios: [{hora:"07h", temp:"20°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Pancadas de chuva à tarde.", umidade: "70% - 95%" },
  6: { min: "19°C", max: "28°C", horarios: [{hora:"07h", temp:"20°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Pancadas de chuva à tarde.", umidade: "70% - 95%" },
  7: { min: "19°C", max: "28°C", horarios: [{hora:"07h", temp:"20°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Pancadas de chuva à tarde.", umidade: "70% - 95%" },
  8: { min: "19°C", max: "28°C", horarios: [{hora:"07h", temp:"20°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Pancadas de chuva à tarde.", umidade: "70% - 95%" },
  // Março
  9: { min: "18°C", max: "27°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"26°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "60%", periodoChuva: "Chuva mais isolada, geralmente à tarde.", umidade: "65% - 90%" },
  10: { min: "18°C", max: "27°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"26°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "60%", periodoChuva: "Chuva mais isolada, geralmente à tarde.", umidade: "65% - 90%" },
  11: { min: "18°C", max: "27°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"26°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "60%", periodoChuva: "Chuva mais isolada, geralmente à tarde.", umidade: "65% - 90%" },
  12: { min: "18°C", max: "27°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"26°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "60%", periodoChuva: "Chuva mais isolada, geralmente à tarde.", umidade: "65% - 90%" },
  // Abril
  13: { min: "16°C", max: "26°C", horarios: [{hora:"07h", temp:"17°C"}, {hora:"12h", temp:"24°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "40%", periodoChuva: "Pouca chuva, tempo mais firme.", umidade: "60% - 85%" },
  14: { min: "16°C", max: "26°C", horarios: [{hora:"07h", temp:"17°C"}, {hora:"12h", temp:"24°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "40%", periodoChuva: "Pouca chuva, tempo mais firme.", umidade: "60% - 85%" },
  15: { min: "16°C", max: "26°C", horarios: [{hora:"07h", temp:"17°C"}, {hora:"12h", temp:"24°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "40%", periodoChuva: "Pouca chuva, tempo mais firme.", umidade: "60% - 85%" },
  16: { min: "16°C", max: "26°C", horarios: [{hora:"07h", temp:"17°C"}, {hora:"12h", temp:"24°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "40%", periodoChuva: "Pouca chuva, tempo mais firme.", umidade: "60% - 85%" },
  // Maio
  17: { min: "13°C", max: "24°C", horarios: [{hora:"07h", temp:"14°C"}, {hora:"12h", temp:"22°C"}, {hora:"17h", temp:"23°C"}], chanceChuva: "25%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "55% - 85%" },
  18: { min: "13°C", max: "24°C", horarios: [{hora:"07h", temp:"14°C"}, {hora:"12h", temp:"22°C"}, {hora:"17h", temp:"23°C"}], chanceChuva: "25%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "55% - 85%" },
  19: { min: "13°C", max: "24°C", horarios: [{hora:"07h", temp:"14°C"}, {hora:"12h", temp:"22°C"}, {hora:"17h", temp:"23°C"}], chanceChuva: "25%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "55% - 85%" },
  20: { min: "13°C", max: "24°C", horarios: [{hora:"07h", temp:"14°C"}, {hora:"12h", temp:"22°C"}, {hora:"17h", temp:"23°C"}], chanceChuva: "25%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "55% - 85%" },
  // Junho
  21: { min: "11°C", max: "23°C", horarios: [{hora:"07h", temp:"12°C"}, {hora:"12h", temp:"21°C"}, {hora:"17h", temp:"22°C"}], chanceChuva: "20%", periodoChuva: "Tempo seco e frio pela manhã.", umidade: "50% - 80%" },
  22: { min: "11°C", max: "23°C", horarios: [{hora:"07h", temp:"12°C"}, {hora:"12h", temp:"21°C"}, {hora:"17h", temp:"22°C"}], chanceChuva: "20%", periodoChuva: "Tempo seco e frio pela manhã.", umidade: "50% - 80%" },
  23: { min: "11°C", max: "23°C", horarios: [{hora:"07h", temp:"12°C"}, {hora:"12h", temp:"21°C"}, {hora:"17h", temp:"22°C"}], chanceChuva: "20%", periodoChuva: "Tempo seco e frio pela manhã.", umidade: "50% - 80%" },
  24: { min: "11°C", max: "23°C", horarios: [{hora:"07h", temp:"12°C"}, {hora:"12h", temp:"21°C"}, {hora:"17h", temp:"22°C"}], chanceChuva: "20%", periodoChuva: "Tempo seco e frio pela manhã.", umidade: "50% - 80%" },
  // Julho
  25: { min: "10°C", max: "23°C", horarios: [{hora:"07h", temp:"11°C"}, {hora:"12h", temp:"21°C"}, {hora:"17h", temp:"22°C"}], chanceChuva: "20%", periodoChuva: "Tempo seco, noites e manhãs frias.", umidade: "45% - 80%" },
  26: { min: "10°C", max: "23°C", horarios: [{hora:"07h", temp:"11°C"}, {hora:"12h", temp:"21°C"}, {hora:"17h", temp:"22°C"}], chanceChuva: "20%", periodoChuva: "Tempo seco, noites e manhãs frias.", umidade: "45% - 80%" },
  27: { min: "10°C", max: "23°C", horarios: [{hora:"07h", temp:"11°C"}, {hora:"12h", temp:"21°C"}, {hora:"17h", temp:"22°C"}], chanceChuva: "20%", periodoChuva: "Tempo seco, noites e manhãs frias.", umidade: "45% - 80%" },
  28: { min: "10°C", max: "23°C", horarios: [{hora:"07h", temp:"11°C"}, {hora:"12h", temp:"21°C"}, {hora:"17h", temp:"22°C"}], chanceChuva: "20%", periodoChuva: "Tempo seco, noites e manhãs frias.", umidade: "45% - 80%" },
  // Agosto
  29: { min: "12°C", max: "25°C", horarios: [{hora:"07h", temp:"13°C"}, {hora:"12h", temp:"23°C"}, {hora:"17h", temp:"24°C"}], chanceChuva: "15%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "40% - 75%" },
  30: { min: "12°C", max: "25°C", horarios: [{hora:"07h", temp:"13°C"}, {hora:"12h", temp:"23°C"}, {hora:"17h", temp:"24°C"}], chanceChuva: "15%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "40% - 75%" },
  31: { min: "12°C", max: "25°C", horarios: [{hora:"07h", temp:"13°C"}, {hora:"12h", temp:"23°C"}, {hora:"17h", temp:"24°C"}], chanceChuva: "15%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "40% - 75%" },
  32: { min: "12°C", max: "25°C", horarios: [{hora:"07h", temp:"13°C"}, {hora:"12h", temp:"23°C"}, {hora:"17h", temp:"24°C"}], chanceChuva: "15%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "40% - 75%" },
  33: { min: "12°C", max: "25°C", horarios: [{hora:"07h", temp:"13°C"}, {hora:"12h", temp:"23°C"}, {hora:"17h", temp:"24°C"}], chanceChuva: "15%", periodoChuva: "Tempo seco, baixa chance de chuva.", umidade: "40% - 75%" },
  // Setembro
  34: { min: "14°C", max: "26°C", horarios: [{hora:"07h", temp:"15°C"}, {hora:"12h", temp:"24°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "35%", periodoChuva: "Aumento da possibilidade de chuva.", umidade: "50% - 80%" },
  35: { min: "14°C", max: "26°C", horarios: [{hora:"07h", temp:"15°C"}, {hora:"12h", temp:"24°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "35%", periodoChuva: "Aumento da possibilidade de chuva.", umidade: "50% - 80%" },
  36: { min: "14°C", max: "26°C", horarios: [{hora:"07h", temp:"15°C"}, {hora:"12h", temp:"24°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "35%", periodoChuva: "Aumento da possibilidade de chuva.", umidade: "50% - 80%" },
  37: { min: "14°C", max: "26°C", horarios: [{hora:"07h", temp:"15°C"}, {hora:"12h", temp:"24°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "35%", periodoChuva: "Aumento da possibilidade de chuva.", umidade: "50% - 80%" },
  // Outubro
  38: { min: "16°C", max: "27°C", horarios: [{hora:"07h", temp:"17°C"}, {hora:"12h", temp:"25°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "50%", periodoChuva: "Chuvas mais frequentes, especialmente à tarde.", umidade: "60% - 85%" },
  39: { min: "16°C", max: "27°C", horarios: [{hora:"07h", temp:"17°C"}, {hora:"12h", temp:"25°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "50%", periodoChuva: "Chuvas mais frequentes, especialmente à tarde.", umidade: "60% - 85%" },
  40: { min: "16°C", max: "27°C", horarios: [{hora:"07h", temp:"17°C"}, {hora:"12h", temp:"25°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "50%", periodoChuva: "Chuvas mais frequentes, especialmente à tarde.", umidade: "60% - 85%" },
  41: { min: "16°C", max: "27°C", horarios: [{hora:"07h", temp:"17°C"}, {hora:"12h", temp:"25°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "50%", periodoChuva: "Chuvas mais frequentes, especialmente à tarde.", umidade: "60% - 85%" },
  // Novembro
  42: { min: "17°C", max: "27°C", horarios: [{hora:"07h", temp:"18°C"}, {hora:"12h", temp:"26°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "65%", periodoChuva: "Pancadas de chuva regulares.", umidade: "65% - 90%" },
  43: { min: "17°C", max: "27°C", horarios: [{hora:"07h", temp:"18°C"}, {hora:"12h", temp:"26°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "65%", periodoChuva: "Pancadas de chuva regulares.", umidade: "65% - 90%" },
  44: { min: "17°C", max: "27°C", horarios: [{hora:"07h", temp:"18°C"}, {hora:"12h", temp:"26°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "65%", periodoChuva: "Pancadas de chuva regulares.", umidade: "65% - 90%" },
  45: { min: "17°C", max: "27°C", horarios: [{hora:"07h", temp:"18°C"}, {hora:"12h", temp:"26°C"}, {hora:"17h", temp:"25°C"}], chanceChuva: "65%", periodoChuva: "Pancadas de chuva regulares.", umidade: "65% - 90%" },
  // Dezembro
  46: { min: "18°C", max: "28°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Verão, com chuvas de fim de tarde.", umidade: "70% - 95%" },
  47: { min: "18°C", max: "28°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Verão, com chuvas de fim de tarde.", umidade: "70% - 95%" },
  48: { min: "18°C", max: "28°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Verão, com chuvas de fim de tarde.", umidade: "70% - 95%" },
  49: { min: "18°C", max: "28°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Verão, com chuvas de fim de tarde.", umidade: "70% - 95%" },
  50: { min: "18°C", max: "28°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Verão, com chuvas de fim de tarde.", umidade: "70% - 95%" },
  51: { min: "18°C", max: "28°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Verão, com chuvas de fim de tarde.", umidade: "70% - 95%" },
  52: { min: "18°C", max: "28°C", horarios: [{hora:"07h", temp:"19°C"}, {hora:"12h", temp:"27°C"}, {hora:"17h", temp:"26°C"}], chanceChuva: "70%", periodoChuva: "Verão, com chuvas de fim de tarde.", umidade: "70% - 95%" },
};


// --- Static Data for Stages (sem data, horario ou previsão) ---
const etapasData = [
  { id: 1, titulo: "Etapa 1: Mogi das Cruzes a Guararema", cidadeDestino: "Guararema", mapaUrl: "https://www.google.com/maps/dir/?api=1&origin=Universidade+de+Mogi+das+Cruzes,+Mogi+das+Cruzes,+SP&destination=Recanto+das+Acácias+Guararema,+Guararema,+SP&travelmode=walking", distancia: "24,4 km", tempoEstimado: "5h 39min", paradaRefeicao: "45min",
  ...
  { id: 2, titulo: "Etapa 2: Guararema a Santa Branca", cidadeDestino: "Santa Branca", mapaUrl: "https://www.google.com/maps/dir/?api=1&origin=Recanto+das+Acácias+Guararema,+Guararema,+SP&destination=Sítio+do+Valdir+(Rota+da+luz),+Paraibuna,+SP&travelmode=walking", distancia: "29,3 km", tempoEstimado: "6h 58min", paradaRefeicao: "60min",
  ...
  { id: 3, titulo: "Etapa 3: Santa Branca a Paraibuna", cidadeDestino: "Paraibuna", mapaUrl: "https://www.google.com/maps/dir/?api=1&origin=Sítio+do+Valdir+(Rota+da+luz),+Paraibuna,+SP&destination=Chororão+Combustíveis,+Paraibuna,+SP&travelmode=walking", distancia: "27,7 km", tempoEstimado: "6h 38min", paradaRefeicao: "60min",
  ...
  { id: 4, titulo: "Etapa 4: Paraibuna a Redenção da Serra", cidadeDestino: "Redenção da Serra", mapaUrl: "https://www.google.com/maps/dir/?api=1&origin=Chororão+Combustíveis,+Paraibuna,+SP&destination=Igreja+Matriz+de+Redenção+da+Serra,+Redenção+da+Serra,+SP&travelmode=walking", distancia: "31,8 km", tempoEstimado: "7h 34min", paradaRefeicao: "60min",
  ...
  { id: 5, titulo: "Etapa 5: Redenção da Serra a Taubaté", cidadeDestino: "Taubaté", mapaUrl: "https://www.google.com/maps/dir/?api=1&origin=Igreja+Matriz+de+Redenção+da+Serra,+Redenção+da+Serra,+SP&destination=Comevap,+Taubaté,+SP&travelmode=walking", distancia: "28,9 km", tempoEstimado: "6h 59min", paradaRefeicao: "60min",
  ...
  { id: 6, titulo: "Etapa 6: Taubaté a Pindamonhangaba", cidadeDestino: "Pindamonhangaba", mapaUrl: "https://www.google.com/maps/dir/?api=1&origin=Comevap,+Taubaté,+SP&destination=Pinda+Palace+Hotel,+Pindamonhangaba,+SP&travelmode=walking", distancia: "25,9 km", tempoEstimado: "5h 56min", paradaRefeicao: "45min",
  ...
  { id: 7, titulo: "Etapa Final: Pindamonhangaba a Aparecida", cidadeDestino: "Aparecida", mapaUrl: "https://www.google.com/maps/dir/?api=1&origin=Pinda+Palace+Hotel,+Pindamonhangaba,+SP&destination=Santuário+Nacional+de+Aparecida,+Aparecida,+SP&travelmode=walking", distancia: "21,5 km", tempoEstimado: "4h 51min", paradaRefeicao: "45min",
...
const EtapaDetalhes = ({ etapa, onBack, isOnline }) => {
  ...
  const previsaoTempo = weeklyHistoricalWeather[weekNumber] || weeklyHistoricalWeather[33]; // Padrão para Agosto
    ...
    <div className="min-h-screen bg-gray-100 font-sans">
      <header className="bg-white shadow-md relative">
         <div className="container mx-auto px-4 py-3 flex justify-between items-center">
            <a href="https://www.amigosdarotadaluz.org/" target="_blank" rel="noopener noreferrer">
                <img src="/favicon-aarl.jpeg" alt="Logotipo AARL" className="h-14" />
            </a>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                ...
                <div className="flex items-center justify-center mt-3 text-orange-600">
                    ...
                    <span className="text-sm font-semibold">
                        {weeklyHistoricalWeather[getWeekNumber(etapa.date)].min} / {weeklyHistoricalWeather[getWeekNumber(etapa.date)].max}
                    </span>
                </div>
              </div>
            </button>
