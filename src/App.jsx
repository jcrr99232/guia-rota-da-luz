  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 text-center">
        ...
        <div className="bg-white p-4 rounded-lg shadow"><p className="text-3xl font-bold text-blue-500">{etapa.distancia}</p><p className="font-semibold text-gray-600">Distância aproximada</p></div>
      ...
      <div className="my-8">
        ...
        {etapa.cidadesDaEtapa && etapa.cidadesDaEtapa.length > 0 && (
          <Card icon={Building} title="Descubra as Cidades da Etapa" colorClass="bg-gray-500">
